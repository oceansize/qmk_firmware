 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | FN   | Ctrl | Alt  | GUI  |Lower |    Space    |Raise | Next |Vol + |Vol - | Play |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    FN,                   KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_MEDIA_FAST_FORWARD, KC__VOLDOWN, KC__VOLUP,   KC_MEDIA_PLAY_PAUSE
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    BACKLIT, XXXXXXX, _______, _______, _______, KC_SPC,  KC_SPC,   _______,  KC_0,    KC_DOT,   KC_EQL,   XXXXXXX
),
...
[_FN] = LAYOUT_planck_grid(
    KC_GRAVE,  KC_F10, KC_F11, KC_F12, XXXXXXX,  XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_DEL,
    XXXXXXX,   KC_F7,  KC_F8,  KC_F9,  XXXXXXX,  XXXXXXX,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX, XXXXXXX,
    XXXXXXX,   KC_F4,  KC_F5,  KC_F6,  XXXXXXX,  XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
